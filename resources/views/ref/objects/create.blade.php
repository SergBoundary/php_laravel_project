...
>                                        <select name='object_group_id' value='object_group_id' id='object_group_id' type='text' placeholder="Группа объектов" class="form-control" title='Группа объектов' required>
