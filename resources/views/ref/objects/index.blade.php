        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <table class="table table-hover">
                    <thead>
                        <th class="align-middle" scope="col" colspan="2">Объект выполнения работ</th>
                    ...
                    <tbody>
                        ...
                        @if ($objectGroups != $objectsRow->object_group)
                        <tr>
                            <td colspan="3" class="text-muted text-uppercase"><em> {{ $objectsRow->country }}</em></td>
                        </tr>
                        @endif
                        <tr>
                            <td> </td>
