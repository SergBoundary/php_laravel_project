            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('ref.manning-tables.store') }}">
                            @csrf
                            @php
...
>                                        <select name='position_id' value='position_id' id='position_id' type='text' placeholder="Должность" class="form-control" title='Должность' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <div class="input-group mb-3"
>                                        <select name='rank_id' value='rank_id' id='rank_id' type='text' placeholder="Уровень квалификации" class="form-control" title='Уровень квалификации' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='quantity' id='quantity' type='text' maxlength="50" class="form-control" title='Количество работников в штате'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='salary'>Оклад</label>
                                    <input name='salary' id='salary' type='text' maxlength="50" class="form-control" title='Оклад'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='tariff'>Тариф</label>
                                    <input name='tariff' id='tariff' type='text' maxlength="50" class="form-control" title='Тариф'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('ref.manning-tables.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('ref.manning-tables.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
