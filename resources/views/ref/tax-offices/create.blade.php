            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('ref.tax-offices.store') }}">
                            @csrf
                            @php
...
>                                        <select name='city_id' value='city_id' id='city_id' type='text' placeholder="Населенный пунк" class="form-control" title='Населенный пунк' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='title' id='title' type='text' maxlength="50" class="form-control" title='Налоговая инспекция'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('ref.tax-offices.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('ref.tax-offices.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
