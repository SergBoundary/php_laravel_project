                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row col-md-12" style="margin-bottom: -10px">
                            ...
                            <div class="ml-auto">
                                @if ($access == 2)
                                <form name="delete" method="POST" action="{{ route('ref.accrual-types.destroy', $accrualTypeData->id) }}">
                                    <div class="form-row">
                                        <div class='form-group col-md-auto'>
                                            @method('DELETE')
                                            @csrf
                                            <a class="btn btn-outline-secondary btn-sm" href="{{ route('ref.accrual-types.index') }}"><img src="/img/visibility_off_black_18dp.png" alt="Закрыть" title="Закрыть"></a>
                                            <a class="btn btn-outline-secondary btn-sm" href="{{ route('ref.accrual-types.edit', $accrualTypeData->id) }}"><img src="/img/edit_black_18dp.png" alt="Изменить" title="Изменить"></a>
                        ...
                        <form name="show">
                            <div class="row justify-content-center">
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='code' value='{{ $objectsList->code }}' id='code' type='text' maxlength="50" readonly class="form-control" title='Код объекта'>
                                </div>
                                <div class='form-group col-md-10'>
