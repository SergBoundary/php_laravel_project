                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('ref.districts.store') }}">
                            ...
                            @endphp
                            @include('ref.districts.includes.result_messages')
                            <div class="row justify-content-center">
...
>                                        <select name='country_id' value='country_id' id='country_id' type='text' placeholder="Название страны" class="form-control" title='Название страны' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='title' id='title' type='text' maxlength="50" class="form-control" title='Название области'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='national_name'>Национальное название области</label>
                                    <input name='national_name' id='national_name' type='text' maxlength="50" class="form-control" title='Национальное название области'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='number_iso'>Код области</label>
                                    <input name='number_iso' id='number_iso' type='text' maxlength="50" class="form-control" title='Код области'>
                                </div>
                                <div class='form-group col-md-10'>
