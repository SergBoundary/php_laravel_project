            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('acc.employee-accrual-years.store') }}">
                            @csrf
                            @php
...
>                                        <select name='currency_kurs_id' value='currency_kurs_id' id='currency_kurs_id' type='text' placeholder="Курс обмена валюты" class="form-control" title='Курс обмена валюты' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('acc.employee-accrual-years.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('acc.employee-accrual-years.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
