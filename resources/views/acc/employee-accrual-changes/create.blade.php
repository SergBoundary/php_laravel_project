            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('acc.employee-accrual-changes.store') }}">
                            @csrf
                            @php
...
>                                        <select name='algorithm_id' value='algorithm_id' id='algorithm_id' type='text' placeholder="Алгоритм начисления" class="form-control" title='Алгоритм начисления' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <div class="input-group mb-3"
>                                        <select name='tax_rates_id' value='tax_rates_id' id='tax_rates_id' type='text' placeholder="Ставка налогообложения" class="form-control" title='Ставка налогообложения' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='date_to' id='date_to' type='text' maxlength="50" class="form-control" title='Переформирование до даты'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='amount'>Новое значение</label>
                                    <input name='amount' id='amount' type='text' maxlength="50" class="form-control" title='Новое значение'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('acc.employee-accrual-changes.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('acc.employee-accrual-changes.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
