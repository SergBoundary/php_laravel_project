                ...
                <div class="row justify-content-center">
                    ...
                    <div class='form-row col-md-12' style="margin-top: 5px">
                        ...
                        <div style="margin-left: 10px;">
                            <div class='form-row'>
                                <div>
                                    <input name='type_{{ $order }}' id='type_{{ $order }}' value='{{ $pieceworkRow->type }}' type='text' readonly class="form-control form-control-sm calc-pieceworks-update" style="width: 300px;" title='Вид работы'>
                                </div>
                                <div>
                                    <input name='unit_{{ $order }}' id='unit_{{ $order }}' value='{{ $pieceworkRow->unit }}' type='text' readonly class="form-control form-control-sm calc-pieceworks-update" style="width: 80px;" title='Единица измерения'>
                                </div>
                                <div>
                                    <input name='quantity_{{ $order }}' id='quantity_{{ $order }}' value='{{ $pieceworkRow->quantity }}' type='text' readonly class="form-control form-control-sm calc-pieceworks-update" style="width: 100px;" title='Количество выполных работ'>
                                </div>
                                <div>
                                    <input name='price_{{ $order }}' id='price_{{ $order }}' value='{{ $pieceworkRow->price }}' type='text' readonly class="form-control form-control-sm calc-pieceworks-update" style="width: 80px;" title='Цена единицы'>
                                </div>
                                <div>
