            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('acc.special-eatings.store') }}">
                            @csrf
                            @php
...
>                                        <select name='personal_card_id' value='personal_card_id' id='personal_card_id' type='text' placeholder="Работник" class="form-control" title='Работник' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <div class="input-group mb-3"
>                                        <select name='year_id' value='year_id' id='year_id' type='text' placeholder="Год расхода" class="form-control" title='Год расхода' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <div class="input-group mb-3"
>                                        <select name='month_id' value='month_id' id='month_id' type='text' placeholder="Месяц расхода" class="form-control" title='Месяц расхода' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='residual_amount' id='residual_amount' type='text' maxlength="50" class="form-control" title='Остаток суммы на начало месяца'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='amount'>Сумма затрат</label>
                                    <input name='amount' id='amount' type='text' maxlength="50" class="form-control" title='Сумма затрат'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='hours'>Отработано часов за месяц</label>
                                    <input name='hours' id='hours' type='text' maxlength="50" class="form-control" title='Отработано часов за месяц'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='unit_price'>Цена питания за штуку</label>
                                    <input name='unit_price' id='unit_price' type='text' maxlength="50" class="form-control" title='Цена питания за штуку'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='unit_quantity'>Положеное количество за месяц</label>
                                    <input name='unit_quantity' id='unit_quantity' type='text' maxlength="50" class="form-control" title='Положеное количество за месяц'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('acc.special-eatings.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('acc.special-eatings.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
