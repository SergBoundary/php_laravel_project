                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Record editing">
                                    <form method="POST" action="{{ route('calc.payrolls.destroy', $payrollsRow->id) }}">
                                        @method('DELETE')
                                        @csrf
                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('calc.payrolls.show', $payrollsRow->id) }}">{{ __('Открыть') }}</a>
                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('calc.payrolls.edit', $payrollsRow->id) }}">{{ __('Изменить') }}</a>
