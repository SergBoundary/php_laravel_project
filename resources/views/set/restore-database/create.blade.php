            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('set.restore-database.store') }}">
                            @csrf
                            @php
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='parametr' id='parametr' type='text' maxlength="50" class="form-control" title='Параметр выполнения команды'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='condition'>Условие запуска команды</label>
                                    <input name='condition' id='condition' type='text' maxlength="50" class="form-control" title='Условие запуска команды'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('set.restore-database.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('set.restore-database.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
