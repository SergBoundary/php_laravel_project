                                    ...
                                    <div class="media-body">
                                        <div class='form-row'>
                                            <div class="col-md-8">
                                                ...
                                                <input name='name' value='{{ $user->name }} {{ $user->surname }}' id='name' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Пользователь'>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class='col-md-3'>
                                                <label id="user-cabinet-appointment-date" for='assignment_date' class="col-form-label col-form-label-sm">{{ $interface['user-cabinet']['user-cabinet-appointment-date'] }}</label>
                                                <input name='assignment_date' value='' id='assignment_date' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Дата назначения'>
                                            </div>
                                            @endif
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class='col-md-3'>
                                                <label id="user-cabinet-allocation-date" for='start' class="col-form-label col-form-label-sm">{{ $interface['user-cabinet']['user-cabinet-allocation-date'] }}</label>
                                                <input name='start' value='' id='start' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Дата перемещения'>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
