            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('hr.salary-cards.store') }}">
                            @csrf
                            @php
...
>                                        <select name='personal_card_id' value='personal_card_id' id='personal_card_id' type='text' placeholder="Работник" class="form-control" title='Работник' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <div class="input-group mb-3"
>                                        <select name='bank_id' value='bank_id' id='bank_id' type='text' placeholder="Банк обслуживания" class="form-control" title='Банк обслуживания' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='payment_card' id='payment_card' type='text' maxlength="50" class="form-control" title='Номер банковской карточки'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='expiry'>Истечение срока действия</label>
                                    <input name='expiry' id='expiry' type='text' maxlength="50" class="form-control" title='Истечение срока действия'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.salary-cards.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.salary-cards.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
