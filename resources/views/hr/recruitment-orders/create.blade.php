            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('hr.recruitment-orders.store') }}">
                            @csrf
                            @php
...
>                                        <select name='personal_card_id' value='personal_card_id' id='personal_card_id' type='text' placeholder="Работник" class="form-control" title='Работник' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <div class="input-group mb-3"
>                                        <select name='dismissal_reason_id' value='dismissal_reason_id' id='dismissal_reason_id' type='text' placeholder="Причина увольнения" class="form-control" title='Причина увольнения' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='employment_date' id='employment_date' type='text' maxlength="50" class="form-control" title='Дата найма'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='employment_order'>Номер приказа о найме</label>
                                    <input name='employment_order' id='employment_order' type='text' maxlength="50" class="form-control" title='Номер приказа о найме'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='probation'>Количество дней стажировки</label>
                                    <input name='probation' id='probation' type='text' maxlength="50" class="form-control" title='Количество дней стажировки'>
                                </div>
                                <div class='form-group col-md-10'>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='dismissal_order' id='dismissal_order' type='text' maxlength="50" class="form-control" title='Номер приказа об увольнении'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.recruitment-orders.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.recruitment-orders.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
