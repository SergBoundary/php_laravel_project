...
>                                        <select name='personal_card_id' value='personal_card_id' id='personal_card_id' type='text' placeholder="Р Р°Р±РѕС‚РЅРёРє" class="form-control" title='Р Р°Р±РѕС‚РЅРёРє' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='title' id='title' type='text' maxlength="50" class="form-control" title='Название бригады'>
                                </div>
                                <div class='form-group col-md-10'>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='start' id='start' type='text' maxlength="50" class="form-control" title='Сформирована'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='expiry'>Расформирована</label>
                                    <input name='expiry' id='expiry' type='text' maxlength="50" class="form-control" title='Расформирована'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.teams.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.teams.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
