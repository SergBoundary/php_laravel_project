...
@section('content')
    ...
    @endphp
    <div id="interface-modul" modul="teams-show"></div>
    <div class="container">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row col-md-12" style="margin-bottom: -10px">
                            ...
                            <div class="ml-auto">
                                @if ($access == 2)
                                <form name="delete" method="POST" action="{{ route('hr.teams.destroy', $teamData->id) }}">
                                    <div class="form-row">
                                        <div class='form-group col-md-auto'>
                                            ...
                                            <a class="btn btn-outline-secondary btn-sm" href="{{ route('hr.teams.edit', $teamData->id) }}"><img src="/img/edit_black_18dp.png" alt="Изменить" title="Изменить"></a>
                        ...
                        <form name="show">
                            <div class="row justify-content-center">
                                <div class='media form-group col-md-11'>
                                    <div>
                                        <img src="{{ $leaderData->photo_url }}" alt="Фото" class="img-thumbnail mr-3" height="180" width="180">
                                    </div>
                                    <div class="media-body">
                                        <div class='form-row'>
                                            <div class="col-md-6">
                                                <label for='team' class="col-form-label col-form-label-sm">Бригада</label>
                                                <input name='team' value='{{ $teamData->title }}' id='team' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Бригада'>
                                            </div>
                                            <div class='col-md-3'>
                                                <label for='start' class="col-form-label col-form-label-sm">Сформирована</label>
                                                <input name='start' value='{{ $teamData->start }}' id='start' type='date' maxlength="50" readonly class="form-control form-control-sm" title='Сформирована'>
                                            </div>
                                            <div class='col-md-3'>
                                                <label for='expiry' class="col-form-label col-form-label-sm">Расформирована</label>
                                                <input name='expiry' value='{{ $teamData->expiry }}' id='expiry' type='date' maxlength="50" readonly class="form-control form-control-sm" title='Расформирована'>
                                            </div>
                                        </div>
                                        <div class='form-row'>
                                            <div class="col-md-5">
                                                <label for='leader' class="col-form-label col-form-label-sm">Бригадир</label>
