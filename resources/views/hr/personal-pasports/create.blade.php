            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('hr.personal-pasports.store') }}">
                            @csrf
                            @php
...
>                                        <select name='personal_card_id' value='personal_card_id' id='personal_card_id' type='text' placeholder="Работник" class="form-control" title='Работник' required>
                                ...
                                <div class='form-group col-md-10'>
                                    ...
                                    <input name='series' id='series' type='text' maxlength="50" class="form-control" title='Серия паспорта'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='number'>Номер паспорта</label>
                                    <input name='number' id='number' type='text' maxlength="50" class="form-control" title='Номер паспорта'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='issuing_date'>Дата выдачи</label>
                                    <input name='issuing_date' id='issuing_date' type='text' maxlength="50" class="form-control" title='Дата выдачи'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='issuing_authority'>Орган выдачи</label>
                                    <input name='issuing_authority' id='issuing_authority' type='text' maxlength="50" class="form-control" title='Орган выдачи'>
                                </div>
                                <div class='form-group col-md-10'>
                                    <label for='expiration date'>Утратит силу</label>
                                    <input name='expiration date' id='expiration date' type='text' maxlength="50" class="form-control" title='Утратит силу'>
                                </div>
                                <div class='form-group col-md-10'>
                                    ...
                                    @if(session('success'))
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.personal-pasports.index') }}">{{ __('Закрыть') }}</a>
                                    @else
                                        <a class='btn btn-outline-secondary' style="margin-left: 10px;" href="{{ route('hr.personal-pasports.index') }}">{{ __('Отмена') }}</a>
                                    @endif
                                </div>
                            </div>
                        </form>
