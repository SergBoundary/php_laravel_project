                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row col-md-12" style="margin-bottom: -10px">
                            ...
                            <div class="ml-auto">
                                @if ($access == 2)
                                <form name="delete" method="POST" action="{{ route('hr.personal-cards.destroy', $personalCardsData->id) }}">
                                    <div class="form-row">
                                        <div class='form-group col-md-auto'>
                                            ...
                                            <a class="btn btn-outline-secondary btn-sm" href="{{ route('hr.personal-cards.edit', $personalCardsData->id) }}"><img src="/img/edit_black_18dp.png" alt="Изменить" title="Изменить"></a>
                                    ...
                                    <div class="media-body">
                                        <div class='form-row'>
                                            <div class="col-md-4">
                                                ...
                                                <input name='surname' value='{{ $personalCardsData->surname }}' id='surname' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Фамилия'>
                                            </div>
                                            <div class="col-md-4">
                                                <label for='first_name' class="col-form-label col-form-label-sm">Имя</label>
                                                <input name='first_name' value='{{ $personalCardsData->first_name }}' id='first_name' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Имя (первое имя)'>
                                            </div>
                                            <div class="col-md-4">
                                                <label for='second_name' class="col-form-label col-form-label-sm">Отчество</label>
                                                <input name='second_name' value='{{ $personalCardsData->second_name }}' id='first_name' type='text' maxlength="50" readonly class="form-control form-control-sm" title='Имя (первое имя)'>
                                            </div>
                                        </div>
                                        <div class='form-row'>
                                            <div class="col-md-3">
