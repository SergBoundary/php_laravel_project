...
class CreateBaseTimesheetsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('base_timesheets', function (Blueprint $table) {
            ...
            $table->char('day_1', 5); // 1 день месяца
            $table->char('day_2', 5); // 2 день месяца
            $table->char('day_3', 5); // 3 день месяца
            $table->char('day_4', 5); // 4 день месяца
            $table->char('day_5', 5); // 5 день месяца
            $table->char('day_6', 5); // 6 день месяца
            $table->char('day_7', 5); // 7 день месяца
            $table->char('day_8', 5); // 8 день месяца
            $table->char('day_9', 5); // 9 день месяца
            $table->char('day_10', 5); // 10 день месяца
            $table->char('day_11', 5); // 11 день месяца
            $table->char('day_12', 5); // 12 день месяца
            $table->char('day_13', 5); // 13 день месяца
            $table->char('day_14', 5); // 14 день месяца
            $table->char('day_15', 5); // 15 день месяца
            $table->char('day_16', 5); // 16 день месяца
            $table->char('day_17', 5); // 17 день месяца
            $table->char('day_18', 5); // 18 день месяца
            $table->char('day_19', 5); // 19 день месяца
            $table->char('day_20', 5); // 20 день месяца
            $table->char('day_21', 5); // 21 день месяца
            $table->char('day_22', 5); // 22 день месяца
            $table->char('day_23', 5); // 23 день месяца
            $table->char('day_24', 5); // 24 день месяца
            $table->char('day_25', 5); // 25 день месяца
            $table->char('day_26', 5); // 26 день месяца
            $table->char('day_27', 5); // 27 день месяца
            $table->char('day_28', 5); // 28 день месяца
            $table->char('day_29', 5); // 29 день месяца
            $table->char('day_30', 5); // 30 день месяца
            $table->char('day_31', 5); // 31 день месяца
