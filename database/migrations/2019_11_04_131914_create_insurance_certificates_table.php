...
class CreateInsuranceCertificatesTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('insurance_certificates', function (Blueprint $table) {
            ...
            $table->date('certificate_start'); // Начало срока действия страхового свидетельства
            $table->date('certificate_expiry'); // Истечение срока действия страхового свидетельства
