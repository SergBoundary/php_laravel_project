...
class CreateEmployeeAccrualMonthsTable extends Migration
{
    /**
     * Run the migrations: Таблица учета сумм начислений работникам за месяц
     *
     * @return void
     */
    public function up()
    {
        Schema::create('employee_accrual_months', function (Blueprint $table) {
            ...
            $table->integer('month_id')->unsigned(); // Учет за указанный месяц
    ...
    {
        Schema::dropIfExists('employee_accrual_months');
    }
}
