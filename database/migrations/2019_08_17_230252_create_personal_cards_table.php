...
{
    /**
     * Run the migrations: Таблица учета неизменяемых персональных данных работника
     *
     * @return void
     */
    public function up()
    {
        Schema::create('personal_cards', function (Blueprint $table) {
            ...
            $table->char('tax_number', 10); // Индивидуальный налоговый номер
            ...
            $table->string('national_surname', 100)->nullable(); // Фамилия на национальном языке работника
            $table->string('national_first_name', 100)->nullable(); // Имя на национальном языке работника
            $table->string('national_second_name', 100)->nullable(); // Отчество на национальном языке работника
