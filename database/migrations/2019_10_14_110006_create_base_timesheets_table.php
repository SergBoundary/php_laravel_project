...
class CreateBaseTimesheetsTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('base_timesheets', function (Blueprint $table) {
            ...
            $table->char('day_1', 5)->nullable(); // 1 день месяца
            $table->char('day_2', 5)->nullable(); // 2 день месяца
            $table->char('day_3', 5)->nullable(); // 3 день месяца
            $table->char('day_4', 5)->nullable(); // 4 день месяца
            $table->char('day_5', 5)->nullable(); // 5 день месяца
            $table->char('day_6', 5)->nullable(); // 6 день месяца
            $table->char('day_7', 5)->nullable(); // 7 день месяца
            $table->char('day_8', 5)->nullable(); // 8 день месяца
            $table->char('day_9', 5)->nullable(); // 9 день месяца
            $table->char('day_10', 5)->nullable(); // 10 день месяца
            $table->char('day_11', 5)->nullable(); // 11 день месяца
            $table->char('day_12', 5)->nullable(); // 12 день месяца
            $table->char('day_13', 5)->nullable(); // 13 день месяца
            $table->char('day_14', 5)->nullable(); // 14 день месяца
            $table->char('day_15', 5)->nullable(); // 15 день месяца
            $table->char('day_16', 5)->nullable(); // 16 день месяца
            $table->char('day_17', 5)->nullable(); // 17 день месяца
            $table->char('day_18', 5)->nullable(); // 18 день месяца
            $table->char('day_19', 5)->nullable(); // 19 день месяца
            $table->char('day_20', 5)->nullable(); // 20 день месяца
            $table->char('day_21', 5)->nullable(); // 21 день месяца
            $table->char('day_22', 5)->nullable(); // 22 день месяца
            $table->char('day_23', 5)->nullable(); // 23 день месяца
            $table->char('day_24', 5)->nullable(); // 24 день месяца
            $table->char('day_25', 5)->nullable(); // 25 день месяца
            $table->char('day_26', 5)->nullable(); // 26 день месяца
            $table->char('day_27', 5)->nullable(); // 27 день месяца
            $table->char('day_28', 5)->nullable(); // 28 день месяца
            $table->char('day_29', 5)->nullable(); // 29 день месяца
            $table->char('day_30', 5)->nullable(); // 30 день месяца
            $table->char('day_31', 5)->nullable(); // 31 день месяца
