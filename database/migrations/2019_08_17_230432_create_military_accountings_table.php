...
class CreateMilitaryAccountingsTable extends Migration
{
    /**
    ...
    public function up()
    {
        Schema::create('military_accountings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('military_accountings');
    }
}
