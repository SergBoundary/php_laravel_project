...
/**
 * Class EmployeeAccrualMonthsCreateRequest: Правила записи сумм начислений работникам за месяц
 *
 * @author SeBo
 *
 * @package App\Http\Requests
 */
class EmployeeAccrualMonthsCreateRequest extends FormRequest {
